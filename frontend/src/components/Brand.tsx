...
export function Brand({ compact = false }: BrandProps) {
  return (
    <Box
      ...
      aria-label="Comvy"
    >
      <Box sx={{ width: 38, height: 38, display: 'grid', placeItems: 'center', flexShrink: 0, filter: 'drop-shadow(0 7px 10px rgba(31,94,255,.22))' }}>
        <Box component="svg" viewBox="0 0 40 40" width={38} height={38} aria-hidden focusable="false">
