...
export interface AssistantDocument { id: string; name: string; documentType: string; originalFileName: string; version: number; isActive: boolean; processingStatus: string; processingError: string | null; needsReindexing?: boolean }
...
export const reprocessDocument = async (condominiumId: string, id: string) => api.post(`/condominiums/${condominiumId}/documents/${id}/reprocess`)
