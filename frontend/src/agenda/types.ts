...
export interface AgendaReminder {
  ...
  requestCount: number; requestIds: string[]
}
export interface AgendaUnit { id: string; identifier: string; block: string | null }
export interface AgendaRequestOption { id: string; protocol: string; title: string; residentName: string; unitIdentifier: string | null; status: string; linkedReminderId: string | null }
