...
import { createFirstAccessLink, listCondominiumMembers, listUnits, onboardMember, resendFirstAccess, resetMemberTemporaryPassword, updateCondominiumMember } from '../management/api'
...
const submit = async (event: FormEvent) => {
  ...
  try {
    ...
    setPrimary(false)
    setResult(null)
    setSuccess(created.firstAccessStatus === 'InviteSent'
...
const beginAdd=()=>{setError('');setSuccess('');setEditing(null);setFullName('');setEmail('');setPhone('');setEmailOnlyLogin(false);setCpf('');setCnpj('');setAddress('');setCity('');setState('');setMembershipActive(true);setUnitMembershipId(null);setUnitId('');setType('Owner');setResident(false);setPrimary(false);setOpen(true)}
