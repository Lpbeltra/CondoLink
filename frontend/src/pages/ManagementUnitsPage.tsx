...
export function ManagementUnitsPage() {
  ...
  return <PageContainer>
    <Stack direction={{ xs: 'column', sm: 'row' }} justifyContent="space-between" gap={2}><Box><Typography variant="h1">Unidades</Typography><Typography color="text.secondary">Consulte unidades e gerencie seus vínculos.</Typography></Box></Stack>
