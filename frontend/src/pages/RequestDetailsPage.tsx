    ...
    <PageContainer>
      ...
      <Grid container spacing={3}>
        <Grid size={{ xs: 12, lg: 8 }}>
          ...
          {managementMode && canViewInternal && <RequestServiceProviderCard requestId={details.id} status={details.status} current={details.serviceProvider} history={details.serviceProviderHistory ?? []} paymentRequests={details.providerPaymentRequests ?? []} requestTitle={details.title} condominium={currentCondominium?.condominium.name} unit={unit} onUpdated={() => load(true)} />}
