    ...
    <PageContainer>
      ...
      <Grid container spacing={3}>
        <Grid size={{ xs: 12, lg: 8 }}>
          ...
          {managementMode && canViewInternal && <RequestServiceProviderCard requestId={details.id} status={details.status} current={details.serviceProvider} history={details.serviceProviderHistory ?? []} onUpdated={()=>void load()} />}
