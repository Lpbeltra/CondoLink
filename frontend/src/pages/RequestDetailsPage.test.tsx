...
import { createRequestMessage, getRequest, listRequestAttachments, listRequestMessages } from '../requests/api'
...
vi.mock('../requests/api', () => ({ getRequest: vi.fn(), listRequestMessages: vi.fn(), listRequestAttachments: vi.fn(), getRequestAttachmentBlob: vi.fn(), createRequestMessage: vi.fn() }))
