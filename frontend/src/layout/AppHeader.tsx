  ...
  return (
    ...
    >
      <Toolbar sx={{ minHeight: { xs: 64, md: 72 }, px: { xs: 1.5, sm: 2, md: 3 }, minWidth: 0, gap: { xs: 1, sm: 1.5 } }}>
        <ButtonBase aria-label="Ir para a página principal" onClick={() => navigate(brandPath)} sx={{ display: { xs: 'flex', sm: 'none' }, flexShrink: 0 }}><Brand compact /></ButtonBase>
        <ButtonBase aria-label="Ir para a página principal" onClick={() => navigate(brandPath)} sx={{ display: { xs: 'none', sm: 'flex' }, flexShrink: 0 }}><Brand /></ButtonBase>
