...
export interface ServiceProvider { id:string; name:string; companyName:string|null; specialty:string; specialties:string[]; contactName:string|null; phone:string; email:string|null; pixKey:string|null; pixKeyType:PixKeyType|null; notes:string|null; isActive:boolean; isMine:boolean; condominiums:{condominiumId:string;name:string}[] }
