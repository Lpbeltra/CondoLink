...
export interface CondominiumMember { membershipId: string; userId: string; fullName: string; cpf?: string | null; cnpj?: string | null; address?: string | null; city?: string | null; state?: string | null; email: string; phoneNumber: string | null; userActive: boolean; mustChangePassword: boolean; lastLoginAt: string | null; membershipActive: boolean; joinedAt: string; endedAt: string | null; roles: string[]; unitLinks: MemberUnitLink[] }
