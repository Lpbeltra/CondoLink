...
internal static class ResidentImportTemplate
{
    internal static readonly string[] Headers =
        ["Bloco", "Unidade", "Nome", "E-mail", "Telefone", "Relacionamento", "Morador", "Residência principal", "Enviar acesso por e-mail"];
    ...
    public static byte[] Create()
    {
        ...
        using (var archive = new ZipArchive(output, ZipArchiveMode.Create, true))
        {
            ...
            var instructions = new[]
            {
                ...
                "Enviar acesso por e-mail: use Sim apenas para um endereço real. Não mantém o primeiro acesso pendente para entrega manual. Arquivos antigos sem a coluna não enviam automaticamente.",
