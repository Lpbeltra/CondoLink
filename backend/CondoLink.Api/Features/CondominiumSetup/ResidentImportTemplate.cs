    ...
    public static byte[] Create()
    {
        ...
        using (var archive = new ZipArchive(output, ZipArchiveMode.Create, true))
        {
            ...
            var instructions = new[]
            {
                ...
                "Enviar primeiro acesso: use WhatsApp, E-mail ou Não. WhatsApp exige telefone válido; E-mail exige endereço entregável. Arquivos antigos sem a coluna assumem Não.",
