...
internal static class ResidentImportTemplate
{
    internal static readonly string[] Headers =
        ["Bloco", "Unidade", "Nome", "E-mail", "Telefone", "Relacionamento", "Morador", "Residência principal"];
    ...
    public static byte[] Create()
    {
        ...
        using (var archive = new ZipArchive(output, ZipArchiveMode.Create, true))
        {
            ...
            Add(archive, "xl/worksheets/sheet1.xml", $"""<?xml version="1.0" encoding="UTF-8" standalone="yes"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><cols><col min="1" max="8" width="22" customWidth="1" style="1"/></cols><sheetData><row r="1">{headerCells}</row></sheetData><dataValidations count="3"><dataValidation type="list" allowBlank="0" sqref="F2:F5001"><formula1>"Proprietário,Inquilino,Morador autorizado"</formula1></dataValidation><dataValidation type="list" allowBlank="0" sqref="G2:G5001"><formula1>"Sim,Não"</formula1></dataValidation><dataValidation type="list" allowBlank="0" sqref="H2:H5001"><formula1>"Sim,Não"</formula1></dataValidation></dataValidations></worksheet>""");
